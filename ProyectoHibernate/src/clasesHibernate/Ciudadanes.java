...
// Generated 17-feb-2018 19:21:49 by Hibernate Tools 4.3.1
...
public class Ciudadanes  implements java.io.Serializable {
     ...
     private Serializable apellidos;
    ...
    public Ciudadanes(int id, Pastas pastas, Serializable nombre, Serializable apellidos, Date fechaNacimiento, char sexo, short kgPasta) {
        this.id = id;
        this.pastas = pastas;
        this.nombre = nombre;
    ...
    public Ciudadanes(int id, Ciudadanes ciudadanesByIdPadre, Ciudadanes ciudadanesByIdMadre, Pastas pastas, Serializable nombre, Serializable apellidos, Date fechaNacimiento, Date fechaMuerte, char sexo, short kgPasta, Set ciudadanesesForIdPadre, Set matrimoniosesForIdconyuge2, Set matrimoniosesForIdconyuge1, Set ciudadanesesForIdMadre) {
       this.id = id;
    ...
    public Serializable getApellidos() {
        return this.apellidos;
    }
    
    public void setApellidos(Serializable apellidos) {
        this.apellidos = apellidos;
    }
