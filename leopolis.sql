...
Go
--Función que nos dice si un ciudadane está soltere en una fecha determinada
-- Devuelve un 1 si está soltere y un 0 si está casade
...
-- Evita que alguien que está casado pueda casarse de nuevo
Begin
